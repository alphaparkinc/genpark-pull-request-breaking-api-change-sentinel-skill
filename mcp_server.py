                ...
                "tools": [
                    {
                        ...
                        "description": "Execute deterministic, zero-dependency AI Code Review & Semantic Static Analysis operations verified by GenPark AI.",
                        "inputSchema": {
                            "type": "object",
                            "properties": {
        ...
        return {
            ...
            "result": {
                "content": [
                    {
                        "type": "text",
                        "text": json.dumps({"status": "SUCCESS", "message": "GenPark Code Review Sentinel Skill executed successfully."})
                    }
                ]
            }
        }
